    ...
    <>
      ...
      <table border="1">
        ...
        <tr>
          ...
          <td>
            As you build your sites, often you’ll want to make modifications and
            test how they look “live” in your browser before committing the
            changes. You can do all this with developer tools, often called dev
            tools for short. Dev tools are a function built into modern web
            browsers that let you see the code behind each section of a site
            right in the browser with just a few clicks. (Hint: dev tools also
            let you peek at the code behind any website so they’re also a great
            way to learn a thing or two from other developers.)
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            experiment and learn from other developers in the same environment.
